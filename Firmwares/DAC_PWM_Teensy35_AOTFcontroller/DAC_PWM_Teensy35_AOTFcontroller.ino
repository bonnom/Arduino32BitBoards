...
//New additions for use of internal DAC
  ...
  unsigned int msblsb1 = 4095;
  unsigned int msblsb2 = 4095;
  unsigned int msblsb3 = 4095;
  unsigned int msblsb4 = 4095;
  unsigned int msblsb5 = 4095;
  unsigned int msblsb6 = 4095;
  unsigned int msblsb7 = 4095;
  unsigned int msblsb[] = {msblsb0,msblsb1,msblsb2,msblsb3,msblsb4,msblsb5,msblsb6,msblsb7};
...
void setup() {
  ...
  analogWriteResolution(12);          // Sets PWM resolution to 12 bits
  analogWriteFrequency(3, 11718.75);  // Sets PWM frequency of pins 3 and 4
  analogWriteFrequency(5, 11718.75);  // Sets PWM frequency of pins 5 and 6
  analogWriteFrequency(7, 11718.75);  // Sets PWM frequency of pins 7 and 8
